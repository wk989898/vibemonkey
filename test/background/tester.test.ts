...
describe("path", () => {
  test("should match any", () => {
    ...
    ["https://www.google.com/", "https://www.google.com/hello/world"].forEach((url) => {
      expect(testScript(url, script)).toBeTruthy();
    });
  });
  ...
  test("should match exact", () => {
    const script = buildScript({
      meta: {
        match: ["https://www.google.com/a/b/c"],
      },
    });
  ...
  test("should be case-sensitive", () => {
    const script = buildScript({
      meta: {
        match: ["https://www.google.com/a?Query", "https://www.google.com/b#Hash"],
      },
    });
    ["https://www.google.com/a?Query", "https://www.google.com/b#Hash"].forEach((url) => {
      expect(testScript(url, script)).toBeTruthy();
    });
    ["https://www.google.com/a?query", "https://www.google.com/b#hash"].forEach((url) => {
      expect(testScript(url, script)).toBeFalsy();
...
describe("include", () => {
  test("should include any", () => {
    ...
    ["https://www.google.com/", "file:///Users/Gerald/file"].forEach((url) => {
      expect(testScript(url, script)).toBeTruthy();
    });
  });
  ...
  test("should include by glob", () => {
    const script = buildScript({
      meta: {
        include: ["https://www.google.com/*", "https://twitter.com/*"],
      },
    });
    ["https://www.google.com/", "https://www.google.com/hello/world"].forEach((url) => {
      expect(testScript(url, script)).toBeTruthy();
  ...
  test("should include by regexp", () => {
    const script = buildScript({
      meta: {
        include: ["/invalid-regexp(/", "/https://www\\.google\\.com/.*/"],
      },
    });
    expect(testScript("https://www.google.com/", script)).toBeTruthy();
    expect(testScript("https://www.hello.com/", script)).toBeFalsy();
  ...
  test("should ignore case", () => {
    const script = buildScript({
      meta: {
        include: ["https://www.google.*", "/regexp/"],
      },
    });
    ["https://www.GOOGLE.com/", "https://www.REGEXP.com/"].forEach((url) => {
      expect(testScript(url, script)).toBeTruthy();
    });
  });
});
...
describe("exclude", () => {
  ...
  test("should include by glob", () => {
    const script = buildScript({
      meta: {
        match: ["*://*/*"],
        excludeMatch: ["https://www.google.com/*", "https://twitter.com/*"],
      },
    });
    ["https://www.google.com/", "https://www.google.com/hello/world"].forEach((url) => {
      expect(testScript(url, script)).toBeFalsy();
...
*://www.google.com/*
`);
    ["http://www.google.com/", "https://www.google.com/"].forEach((url) => {
...
`);
    ["https://www.google.com/", "https://www.google.com/whatever"].forEach((url) => {
      expect(testBlacklist(url)).toBeTruthy();
    });
